...
// Client presentation for the hero. Data is fetched in the HeroSection server
// component (getHero, 1-hour ISR) and passed in as props; all the entrance
// animations (framer-motion) stay here.
      ...
      <div className="relative z-10 w-full flex flex-col">
        ...
        <div className="mt-16 md:mt-32 flex flex-col md:flex-row justify-between items-start md:items-end w-full gap-6 md:gap-8">
          <motion.div
            ...
            className="font-mono text-xs uppercase text-zinc-400 max-w-[200px] whitespace-pre-line"
          >
            {roleLabel}
          </motion.div>
