...
const ABOUT_TEXT =
  "I'M A FULL-STACK WEB DEVELOPER FROM TYRE, LEBANON, SPECIALIZING IN THE MERN STACK AND NEXT.JS ECOSYSTEM. I WORK TO ENGINEER END-TO-END PRODUCTION WEB APPLICATIONS AND OPTIMIZE TECHNICAL SEO. I ENJOY TRANSLATING COMPLEX REQUIREMENTS INTO HIGHLY SCALABLE DIGITAL PLATFORMS WITH SECURE CUSTOM APIS AND SEAMLESS USER EXPERIENCES.";
...
export const TextAboutSection: React.FC = () => {
